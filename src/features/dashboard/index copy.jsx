            ...
            <div className="flex flex-col lg:flex-row">
                <div className="mr-0 basis-3/5 md:mr-8">       
                    ...
                    <div className="pt-8">
                        <div className="flex flex-row p-8 border-2 bg-base-200/50 rounded-xl">
                            <div className="container mx-auto mt-4">
                            <h1 className="mb-4 text-2xl font-bold">Instrumentos aprobados</h1>
                            <table className="table-auto">
                                <thead>
                                <tr>
                                    <th className="px-4 py-2">Id</th>
                                    <th className="px-4 py-2">Año</th>
                                    <th className="px-4 py-2">Pprrd</th>
                                    <th className="px-4 py-2">Evar</th>
                                ...
                                {asistenciasdetalles.map((at) => (
                                    ...
                                    <td className="px-4 py-2 border">{at.pprrd}</td>
                                    <td className="px-4 py-2 border">{at.evar}</td>
                                    <td className="px-4 py-2 border">{at.otros}</td>
                                    </tr>
                                ))}
                                </tbody>
                            </table>
