...
const statsData = [
    ...
    // {title : "OTROS", value : "0", icon : <UsersIcon className='w-8 h-8'/>, description : "↙ Caducados"},
]
...
const Index = () => {
    ...
    const getData = () => {
        ...
        //axiosClient.get('/atdepartamento/3/0')
        axiosClient.get(`/atdepartamento/3/${ubigodepartamento}`)
            .then(({ data }) => {
                setLoading(false);
    ...
    return (
        ...
        <div className="grid m-4 font-sans">
            ...
            <h1 className="text-4xl font-bold"> Dashboard </h1>
                ...
                OTROS INSTRUMENTOS PARA LA GESTIÓN DEL RIESGO DE DESASTRES</p>                
                        ...
                        <div className="pt-2">
                            <div className="flex flex-row p-8 border-2 bg-base-200/50 rounded-xl">
                                <div className="container mx-auto mt-4">
                                    <h1 className="mb-4 text-lg font-bold text-center">OTROS</h1>                              
