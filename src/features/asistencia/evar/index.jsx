...
const Index = () => {
    ...
    const handleDepartamentoChange = (event) => {
        ...
        //console.log('Dentro del componente EVAR : ', event.target.value); // Do something with the selected value
    };
    const handleUbigeoReset = (newValue) => {
        setUbigeodepartamento(newValue);
        //console.log('Dentro del componente EVAR handleUbigeoReset : ', newValue); // Do something with the selected value
    };
    useEffect(() => {
    ...
    const getData = () => {
        ...
        //axiosClient.get('/atdepartamento/4/0')
        axiosClient.get(`/atdepartamento/4/${ubigodepartamento}`)
            .then(({ data }) => {
                setLoading(false);
    ...
    <div className="grid m-4 font-sans">
        ...
        {/* <div className="p-8 pl-0 border-b-2 border-gray-200">
          <h1 className="text-4xl font-bold"> Dashboard </h1>
            ...
            EVALUACIÓN DE RIESGOS ORIGINADOS POR FENÓMENOS NATURALES (EVAR)</p>
                ...
                <div className="mr-0 basis-3/5 md:mr-2">       
                    <div className="pt-2">
                        ...
                        <div className="container mx-auto mt-4">
                            <h1 className="mb-4 text-lg font-bold text-center">EVAR</h1>                         
